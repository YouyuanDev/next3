...
<div class="body">
  ...
  <div class="dialog">
    <table>
      ...
      <tr class="prop">
        <td valign="top" class="name"><g:message code="user.party.label" default="Party"/></td>

        <td valign="top" class="value"><g:link controller="party" action="show" id="${userInstance?.party?.id}">${userInstance?.party?.encodeAsHTML()}</g:link></td>
