  ...
  <script type="text/javascript">
    $(document).ready(function() {
      var upload = new AjaxUpload('#UploadButton', {
        action: "${resource(dir:'')}/${controllerName}/uploadMagnitude/",
        data : {
...
<table id="UploadForm">
  ...
  <tr class="prop">
    <td class="name">
      <label><g:message code="bpinvoice.upload.label" default="Column 1: Style Code , Column 2: Manitude Code"/></label>
    </td>
     
  </tr>
  <tr class="prop">
    <td class="name">
      <label><g:message code="bpinvoice.upload.label" default="Magnitude File(.xls)"/></label>
    </td>
    <td class="value">
